...
function f8() {
  ...
  out8.innerHTML =
    '<input type="text" class="i-81"><button class="b-81">button</button>';
...
function f9() {
  ...
  let out81 = document.querySelector(".out-9");
  if (input9.checked) {
    out81.innerHTML = input9.value;
  } else {
    out81.innerHTML = 0;
  }
}
...
function f10() {
  ...
  let out81 = document.querySelector(".out-10");
  out81.style.background = input10.value;
}
...
function f14() {
  let input14 = document.querySelector(".t-14");
  let out14 = document.querySelector(".out-14");
  out14.innerHTML = input14.value;
}
...
function f15() {
  ...
  let textInput15 = document.querySelector(".t-15");
  let out15 = document.querySelector(".out-15");
  textInput15.value = input15.value;
  out15.innerHTML = textInput15.value;
}
...
function f19() {
  ...
  out19.innerHTML = input191.value + " " + input192.value;
}
...
function f20(e) {
  ...
  out20.innerHTML = form['username'].value + ' ' + form['password'].value;
